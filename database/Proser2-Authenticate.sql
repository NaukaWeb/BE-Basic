...
CREATE TABLE `Transactions` (
  ...
  `transUserId` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `transPrevious` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `transNew` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
